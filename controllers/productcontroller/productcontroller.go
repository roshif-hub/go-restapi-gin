...
func Update(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"messege": "Data berhasil diperbarui"})
...
func Delete(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(&input); err != nil {
		c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{"messege" : err.Error()})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{"messege": "Data berhasil dihapus"})
}